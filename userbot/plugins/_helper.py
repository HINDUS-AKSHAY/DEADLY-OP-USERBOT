...
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "DEADLY USERBOT"
            ...
            if len(string) > 69:
                with io.BytesIO(str.encode(string)) as out_file:
                    ...
                    await bot.send_file(
                        ...
                        force_document=True,
                        allow_cache=False,
                        caption="**COMMANDS** In DEADLY USERBOT",
...
async def _(event):
    ...
    await event.edit("Telethon UserBot powered by DeaDLY UseRBoT")
